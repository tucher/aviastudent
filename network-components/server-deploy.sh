...
pip3 install tornado django psycopg2 djangorestframework markdown django-filter uwsgi python-social-auth djangorestframework-jwt requests django-pgjson pytz
